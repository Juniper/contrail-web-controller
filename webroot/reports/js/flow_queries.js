...
frQuery['columnDisplay'] = [
    ...
    {select:"UuidKey", display:{id:"UuidKey", field:"UuidKey", width:250, name:"UUID", groupable:true, formatter: function(r, c, v, cd, dc){ return handleNull4Grid(dc.UuidKey);}}},
    {select:"sg_rule_uuid", display:{id:"sg_rule_uuid", field:"sg_rule_uuid", width:250, name:"Rule UUID", groupable:true, formatter: function(r, c, v, cd, dc){ return handleNull4Grid(dc.sg_rule_uuid);}}},
    {select:"nw_ace_uuid", display:{id:"nw_ace_uuid", field:"nw_ace_uuid", width:250, name:"Network UUID", groupable:true, formatter: function(r, c, v, cd, dc){ return handleNull4Grid(dc.nw_ace_uuid);}}},
