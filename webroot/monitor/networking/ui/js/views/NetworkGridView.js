            ...
            body: {
                options: {
                    ...
                    detail: {
                        ...
                        onExpand : function() {
                            $(".key:contains(RegionName)").addClass('grid-regionname-heading regionname-label-text');
                            $(".key:contains(RegionName)~span").addClass('grid-regionname-heading regionname-value-text');
                        }
                    },
                    fixedRowHeight: 30
                },
