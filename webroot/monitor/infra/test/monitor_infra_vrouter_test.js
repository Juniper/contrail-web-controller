...
test("testParseInterfaceData", function() {
    //Declare the number of assert statements in current test case
    expect(4);
    deepEqual(monitorInfraComputeInterfacesClass.parseInterfaceData(infraComputeMockData.getInput({fnName:'parseInterfaceData',type:'test1'})),
        infraComputeMockData.getOutput({fnName:'parseInterfaceData',type:'test1'}),'Test parseInterfaceData with valid data');
    deepEqual(monitorInfraComputeInterfacesClass.parseInterfaceData(infraComputeMockData.getInput({fnName:'parseInterfaceData',type:'test2'})),
            infraComputeMockData.getOutput({fnName:'parseInterfaceData',type:'test2'}),'Test parseInterfaceData with valid data');
    deepEqual(monitorInfraComputeInterfacesClass.parseInterfaceData(infraComputeMockData.getInput({fnName:'parseInterfaceData',type:'test3'})),
            infraComputeMockData.getOutput({fnName:'parseInterfaceData',type:'test3'}),'Test parseInterfaceData with empty object data');
    deepEqual(monitorInfraComputeInterfacesClass.parseInterfaceData(infraComputeMockData.getInput({fnName:'parseInterfaceData',type:'test4'})),
...
test("testParseVNData", function() {
    //Declare the number of assert statements in current test case
    expect(3);
    deepEqual(monitorInfraComputeNetworksClass.parseVNData(infraComputeMockData.getInput({fnName:'parseVNData',type:'test1'})),
        infraComputeMockData.getOutput({fnName:'parseVNData',type:'test1'}),'Test parseVNData with valid data');
    deepEqual(monitorInfraComputeNetworksClass.parseVNData(infraComputeMockData.getInput({fnName:'parseVNData',type:'test2'})),
            infraComputeMockData.getOutput({fnName:'parseVNData',type:'test2'}),'Test parseVNData with valid data');
    deepEqual(monitorInfraComputeNetworksClass.parseVNData(infraComputeMockData.getInput({fnName:'parseVNData',type:'test3'})),
...
test("testParseUnicastRoutesData", function() {
    //Declare the number of assert statements in current test case
    expect(2);
    deepEqual(monitorInfraComputeRoutesClass.parseUnicastRoutesData(infraComputeMockData.getInput({fnName:'parseUnicastRoutesData',type:'test1'})),
        infraComputeMockData.getOutput({fnName:'parseUnicastRoutesData',type:'test1'}),'Test parseUnicastRoutesData with valid data');
    deepEqual(monitorInfraComputeRoutesClass.parseUnicastRoutesData(infraComputeMockData.getInput({fnName:'parseUnicastRoutesData',type:'test2'})),
...
test("testParseMulticastRoutesData", function() {
    //Declare the number of assert statements in current test case
    expect(2);
    deepEqual(monitorInfraComputeRoutesClass.parseMulticastRoutesData(infraComputeMockData.getInput({fnName:'parseMulticastRoutesData',type:'test1'})),
        infraComputeMockData.getOutput({fnName:'parseMulticastRoutesData',type:'test1'}),'Test parseMulticastRoutesData with valid data');
    deepEqual(monitorInfraComputeRoutesClass.parseMulticastRoutesData(infraComputeMockData.getInput({fnName:'parseMulticastRoutesData',type:'test2'})),
...
test("testParseL2RoutesData", function() {
    //Declare the number of assert statements in current test case
    expect(2);
    deepEqual(monitorInfraComputeRoutesClass.parseL2RoutesData(infraComputeMockData.getInput({fnName:'parseL2RoutesData',type:'test1'})),
        infraComputeMockData.getOutput({fnName:'parseL2RoutesData',type:'test1'}),'Test parseL2RoutesData with valid data');
    deepEqual(monitorInfraComputeRoutesClass.parseL2RoutesData(infraComputeMockData.getInput({fnName:'parseL2RoutesData',type:'test2'})),
...
test("testParseACLData", function() {
	//Declare the number of assert statements in current test case
	expect(5);
	deepEqual(monitorInfraComputeACLClass.parseACLData(infraComputeMockData.getInput({fnName:'parseACLData',type:'test1'})),
	  infraComputeMockData.getOutput({fnName:'parseACLData',type:'test1'}),'Test parseACLData with valid data');
	deepEqual(monitorInfraComputeACLClass.parseACLData(infraComputeMockData.getInput({fnName:'parseACLData',type:'test2'})),
	      infraComputeMockData.getOutput({fnName:'parseACLData',type:'test2'}),'Test parseACLData with no data');
	deepEqual(monitorInfraComputeACLClass.parseACLData(infraComputeMockData.getInput({fnName:'parseACLData',type:'test3'})),
		      infraComputeMockData.getOutput({fnName:'parseACLData',type:'test3'}),'Test parseACLData with no data');
	deepEqual(monitorInfraComputeACLClass.parseACLData(infraComputeMockData.getInput({fnName:'parseACLData',type:'test4'})),
		      infraComputeMockData.getOutput({fnName:'parseACLData',type:'test4'}),'Test parseACLData with null data');
	deepEqual(monitorInfraComputeACLClass.parseACLData(infraComputeMockData.getInput({fnName:'parseACLData',type:'test5'})),
...
test("testParseFlowsData", function() {
	//Declare the number of assert statements in current test case
	expect(1);
	deepEqual(monitorInfraComputeFlowsClass.parseFlowsData(infraComputeMockData.getInput({fnName:'parseFlowsData',type:'test1'})),
