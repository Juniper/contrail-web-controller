...
test("testVRouterParsing", function() {
    ...
    expect(1);
    deepEqual(infraMonitorView.parsevRoutersDashboardData(infraMockData.getInput({fnName:'parsevRoutersDashboardData',type:'VROUTER_SUMMARY'})),
...
test("test Config Nodes Parsing", function() {
    expect(1);
    deepEqual(infraMonitorView.parseConfigNodesDashboardData(infraMockData.getInput({fnName:'parseConfigNodesDashboardData',type:'CONFIGNODES_SUMMARY'})),
...
test("test Control Nodes Parsing", function() {
    expect(1);
    var actual = infraMonitorView.parseControlNodesDashboardData(infraMockData.getInput({fnName:'parseControlNodesDashboardData',type:'CONTROLNODES_SUMMARY'}));
...
test("test Analytics Nodes Parsing", function() {
    expect(1);
    deepEqual(infraMonitorView.parseAnalyticNodesDashboardData(infraMockData.getInput({fnName:'parseAnalyticNodesDashboardData',type:'ANALYTICSNODES_SUMMARY'})),
...
test("testVRouterConfigMissing", function() {
    ...
    var vRouterData = infraMonitorView.parsevRoutersDashboardData(vRouterDataInput); 
...
//    expect(1);
//    deepEqual(infraMonitorView.processAlerts(infraMockData.getInput({fnName:'processAlerts',type:'test1'})),
...
test("Testing Vrouter getNodeAlerts", function() {
    ...
    emptyObj = infraMonitorView.parsevRoutersDashboardData(emptyObj)[0];
    deepEqual(infraMonitorView.processvRouterAlerts(emptyObj),infraMockData.getOutput({fnName:'processAlerts',type:'Vrouter_UVE_ConfigMissingVrouter'}),
    ...
    nullCase = infraMonitorView.parsevRoutersDashboardData(nullCase)[0];
    deepEqual(infraMonitorView.processvRouterAlerts(nullCase),infraMockData.getOutput({fnName:'processAlerts',type:'Vrouter_UVE_ConfigMissingVrouter'}),
    ...
    alertsData = infraMonitorView.parsevRoutersDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processvRouterAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'Vrouter_partialSystemInfo'}),
    ...
    alertsData = infraMonitorView.parsevRoutersDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processvRouterAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'Vrouter_xmpp_interface_down'}),
    ...
    alertsData = infraMonitorView.parsevRoutersDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processvRouterAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'Vrouter_config_ip_missing'}),
...
test("Testing Control Node getNodeAlerts", function() {
    ...
    emptyObj = infraMonitorView.parseControlNodesDashboardData(emptyObj)[0];
    deepEqual(infraMonitorView.processControlNodeAlerts(emptyObj),infraMockData.getOutput({fnName:'processAlerts',type:'ControlNode_UVE_ConfigMissingVrouter'}),
    ...
    nullCase = infraMonitorView.parseControlNodesDashboardData(nullCase)[0];
    deepEqual(infraMonitorView.processControlNodeAlerts(nullCase),infraMockData.getOutput({fnName:'processAlerts',type:'ControlNode_UVE_ConfigMissingVrouter'}),
    ...
    alertsData = infraMonitorView.parseControlNodesDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processControlNodeAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'ControlNode_partialSystemInfo_downpeers'}),
    ...
    alertsData[0]['value']['BgpRouterState']['ifmap_info']['connection_status'] = 'Up';
    alertsData = infraMonitorView.parseControlNodesDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processControlNodeAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'ControlNode_bgppeer_mismatch'}),
    ...
    alertsData = infraMonitorView.parseControlNodesDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processControlNodeAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'ControlNode_ip_mismatch_IfmapDown'}),
...
test("Testing Analytics Node getNodeAlerts", function() {
    ...
    alertsData = infraMonitorView.parseAnalyticNodesDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processAnalyticsNodeAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'AnalyticsNode_partial_info'}),
            'Testing node alerts with Control Node Config and UVE empty objects');
...
test("Testing Config Node getNodeAlerts", function() {
    ...
    alertsData = infraMonitorView.parseConfigNodesDashboardData(alertsData)[0];
    deepEqual(infraMonitorView.processConfigNodeAlerts(alertsData),infraMockData.getOutput({fnName:'processAlerts',type:'ConfigNode_partial_info'}),
