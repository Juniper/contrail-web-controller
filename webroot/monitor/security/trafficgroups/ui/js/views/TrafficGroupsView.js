        ...
        function(_, ContrailView, ContrailChartsView,
            ...
            var tgView,
                ...
                showLinkInfo: function(d,el,e,option) {
                    ...
                    var srcId = tgHelpers.removeEmptyTags(
                            _.result(srcNodeData, '0.data.currentNode.displayLabels'), tgView.tgSetObj),
                        dstId = tgHelpers.removeEmptyTags(
                            _.result(dstNodeData, '0.data.currentNode.displayLabels'), tgView.tgSetObj);
                            ...
                            config: $.extend({},{
                                ...
                                hierarchyConfig: {
                                    parse: function(d) {
                                        ...
                                        return tgHelpers.parseHierarchyConfig(d, tgView.tgSetObj, project)
                                    }
                                    /*function (d) {
                                ...
                                formatter: function formatter(data) {
                                    if(data.level) {
                                        ...
                                        _.each(links, function(link) {
                                            ...
                                            linkData.items.push({
                                                name: tgHelpers.removeEmptyTags(
                ...
                querySessionSeries: function(reqObj) {
                    var self = this,
                        selectedTime = tgHelpers.getSelectedTime(tgView.tgSetObj);
                        clientPostData = {
                            "session_type": "client",
                ...
                updateCircleLegends: function() {
                    var trafficChartLegendTmpl =
                        ...
                        innerLegends = [],
                        sliceByProject =
                            tgHelpers.getSettingValue('sliceByProject', false);
