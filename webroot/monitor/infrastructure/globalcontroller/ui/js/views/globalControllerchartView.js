    ...
    var chartView = ContrailView.extend({
        render: function (viewConfig) {
            var self = this,
                ...
                var secondRowtopLeftchartContainer = self.$el.find(".row .col1 .topleftchartcontainer");
                var secondRowtopRightchartContainer = self.$el.find(".row .col2 .toprightchartcontainer");
                var secondRowbottomLeftchartContainer = self.$el.find(".row .col3 .bottomleftchartcontainer");
                var secondRowbottomRightchartContainer = self.$el.find(".row .col4 .bottomrightchartcontainer");
                if(region != null){
