    ...
    var getControlNodeDetailPageViewConfig = function (viewConfig) {
        ...
        return {
            ...
            viewConfig: {
                ajaxConfig: {
                    url: contrail.format(
                            monitorInfraConstants.monitorInfraUrls['CONTROLNODE_DETAILS'],
                            hostname),
                    type: 'GET'
                },
                ...
                dataParser: function(result) {
                    ...
                    var obj = monitorInfraParsers.parseControlNodesDashboardData([result])[0];
                    //Further parsing required for Details page done below
                    var overallStatus;
                    try{
                        overallStatus = monitorInfraUtils.getOverallNodeStatusForDetails(obj);
