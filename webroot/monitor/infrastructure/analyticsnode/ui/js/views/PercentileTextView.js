       ...
       function(_, ContrailView,ContrailListModel){
        ...
        render : function (){
            var percentileTextViewTemplate = contrail.getTemplate4Id(
                    cowc.PERCENTILE_TEXT_VIEW_TEMPLATE);
        ...
        renderTemplate: function (selector, viewConfig, chartViewModel,percentileTextViewTemplate) {
            ...
            if(chartModelItems){
            self.$el.html(percentileTextViewTemplate({percentileMessagesobjVal: chartModelItems[0].percentileMessagesobjVal ,percentileSizeobjVal: chartModelItems[0].percentileSizeobjVal}));
              }
           }
    });
