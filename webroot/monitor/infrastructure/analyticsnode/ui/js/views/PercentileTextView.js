...
define(['underscore', 'contrail-view', 'contrail-list-model'],
       function(_, ContrailView,ContrailListModel){
        ...
        renderTemplate: function (selector, viewConfig, chartViewModel,percentileTextViewTemplate) {
            ...
            self.$el.html(percentileTextViewTemplate({percentileXobjVal: percentileXobjVal ,percentileYobjVal: percentileYobjVal, percentileTitle: viewConfig.percentileTitle, percentileYvalue: viewConfig.percentileYvalue,percentileXvalue: viewConfig.percentileXvalue}));
           }
    });
