                                              ...
                                              configData)
{
    ...
    console.log('In postProcessAnalyticsNodeSummaryJSON');
    console.log("UVE",JSON.stringify(collUVEData));
    console.log("genUVE",JSON.stringify(genUVEData));
          ...
          try {
            ...
            resultJSON[lastIndex]['value'] =
                commonUtils.copyObject(resultJSON[lastIndex]['value'],
                                       collData[i]['value']);
            console.log('resultJSON after the anaCata is copied', JSON.stringify(resultJSON));
                resultJSON[lastIndex] =
                    fillAnalyticsConfigData(resultJSON[lastIndex],
                                            configData);
                console.log('resultJSON after the configData is copied', JSON.stringify(resultJSON));
                ...
                try {
                    ...
                    resultJSON[lastIndex]['value']['derived-uve'][mod] =
                        commonUtils.copyObject(resultJSON[lastIndex]['value']['derived-uve'][mod],
                                               genData[j]['value']);
                    console.log('resultJSON after the GenData is copied', JSON.stringify(resultJSON));
                } catch (e) {
                    continue;
                }
            }
