...
define(['underscore', 'contrail-view',
        ...
        render : function (){
            ...
            if (self.model != null) {
                ...
                self.model.onDataUpdate.subscribe(function (e, obj) {
                    //console.log(" MODAL DATA SUBSCRIBING NOW ");
                    //console.log(" self.model.isPrimaryRequestInProgress(): ", self.model.isPrimaryRequestInProgress());
    ...
    function xCPUChartFormatter(xValue, tickCnt) {
        console.log("xValue: ", xValue + " Date: ", new Date(xValue));
