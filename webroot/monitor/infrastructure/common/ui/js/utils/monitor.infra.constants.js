...
define([
    ...
    var MonitorInfraConstants = function () {
        ...
        this.monitorInfraUrls = {
                ...
                VROUTER_DETAILS             : '/api/admin/monitor/infrastructure/vrouter/details?hostname={0}&basic={1}&rawUVE={2}',
                ...
                CONTROLNODE_DETAILS         : '/api/admin/monitor/infrastructure/controlnode/details?hostname={0}&rawUVE={1}',
                ...
                ANALYTICS_DETAILS           : '/api/admin/monitor/infrastructure/analyticsnode/details?hostname={0}&rawUVE={1}',
                ...
                CONFIG_DETAILS              : '/api/admin/monitor/infrastructure/confignode/details?hostname={0}&rawUVE={1}',

                DATABASE_SUMMARY            : '/api/admin/monitor/infrastructure/dbnodes/summary',
                DATABASE_DETAILS            : '/api/admin/monitor/infrastructure/dbnode/details?hostname={0}&rawUVE={1}',
