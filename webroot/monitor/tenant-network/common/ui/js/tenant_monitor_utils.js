...
var tenantNetworkMonitorUtils = {
    ...
    parseInstDetails: function(data,rowData,grid) {
        var d = data;
        ...
        /*
         * Updating the last one hour stats in the row, on row expansion
         */
        if(grid != null) {
            ...
            for(var i = 0; i < gridData.length; i++) {
                if(gridData[i]['cgrid'] == rowData['cgrid']) {
                    gridData[i]['inBytes'] = inBytes;
                    gridData[i]['outBytes'] = outBytes;
                }
            }
