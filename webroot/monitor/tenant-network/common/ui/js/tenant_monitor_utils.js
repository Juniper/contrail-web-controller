...
var tenantNetworkMonitorUtils = {
    ...
    parseInstDetails: function(data,rowData) {
        ...
        $.each(interfaces,function(idx,obj) {
            ...
            intfInBw = $.isNumeric(intfInBw) && $.isNumeric(samplesCount) ? intfInBw/samplesCount : intfInBw;
            intfOutBw = $.isNumeric(intfOutBw) && $.isNumeric(samplesCount) ? intfOutBw/samplesCount : intfOutBw;
        ...
        throughputIn = $.isNumeric(throughputIn) && $.isNumeric(allSamples) ? throughputIn/allSamples : throughputIn;
        throughputOut = $.isNumeric(throughputOut) && $.isNumeric(allSamples) ? throughputOut/allSamples : throughputOut;
