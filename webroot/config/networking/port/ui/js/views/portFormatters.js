    ...
    var PortFormatters = function() {
        ...
        */
        this.sgDDFormatter = function(response, edit, portModel) {
            ...
            if(!edit) {
                //portModel.model.is_sec_grp = true;
        ...
        */
        this.computeUUIDFormatter = function(response) {
            var vmArray = [];
        ...
        */
        this.routerFormater = function(response) {
            var lrReturn = [];
            if(response != null && response != "" &&
        ...
        */
        this.subInterfaceFormatter = function(response) {
