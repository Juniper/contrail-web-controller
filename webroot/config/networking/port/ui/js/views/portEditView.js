           ...
           this.fetchAllData(this ,
                function(allNetworksDS, allNetwork) {
                   ...
                   if(options['mode'] == "edit") {
                    ...
                    if(options['mode'] != "edit" && subnetDS.length > 0) {
                        ...
                        viewConfig: {
                            ...
                            elementConfig:{
                                ...
                                dataSource : {
                                    ...
                                    parse: portFormatter.computeUUIDFormatter
                                }
                            }
                        }
                        },{
                        ...
                        viewConfig: {
                            ...
                            elementConfig:{
                                ...
                                dataSource : {
                                   ...
                                   parse: portFormatter.routerFormater
                                }
                            }}
                        }]
                    }, {
                            ...
                            viewConfig: {
                                ...
                                elementConfig:{
                                   ...
                                   dataSource : {
                                      ...
                                      parse: portFormatter.subInterfaceFormatter
                                   }
                                }
                            }
                        }]
