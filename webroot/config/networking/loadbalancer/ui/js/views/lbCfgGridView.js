...
define([
    ...
    function  getRowActionConfig (dc) {
        ...
        rowActionConfig.push(ctwgc.getAssociateConfig('Associate Floating IP', function(rowIndex) {
        ...
        rowActionConfig.push(ctwgc.getDisassociateConfig('Diassociate Floating IP', function(rowIndex) {
            var dataView = $('#' + ctwl.CFG_LB_GRID_ID).data("contrailGrid")._dataView;
            var item = dataView.getItem(rowIndex);
