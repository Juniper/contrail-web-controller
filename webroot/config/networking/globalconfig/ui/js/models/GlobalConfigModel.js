...
define([
    'underscore',
    'contrail-model',
    'config/networking/globalconfig/ui/js/models/IPSubnetModel',
    'config/networking/globalconfig/ui/js/models/EncapPriorityModel'
    ...
    var GlobalConfigModel = ContrailModel.extend({
        ...
        getEncapPriorities: function() {
            return ['MPLSoGRE', 'VXLAN', 'MPLSoUDP'];
        },
        ...
        addEncapPriOrders: function(data, dataObj, index) {
            var prioOrdList = [];
            var encapPriorityList = ['MPLSoGRE', 'MPLSoUDP', 'VXLAN'];
        ...
        configureGlobalConfig: function (configData, callbackObj) {
            ...
            if (this.model().isValid(true, "globalConfigValidations")) {
                ...
                putData['global-vrouter-config']['encapsulation_priorities']
                       ['encapsulation'] =
                    this.getEncapPriOrdList(newGlobalConfig);
