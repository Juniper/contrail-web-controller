...
function updateBridgeDomains(vnId, vnPutData, appData, callback)
{
    configApiServer.apiGet("/virtual-network/" + vnId, appData,
            function(err, configData){
                 ...
                 editBridgeDomains(editBDDataList, appData, function(){
                     deleteBridgeDomainAsync(deleteBDObjList, function(){
                         createBridgeDomains(createBDDataList, appData, function(){
                             callback();
                         })
                     });
                 });
