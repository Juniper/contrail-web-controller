                    ...
                    if (type.indexOf("bgp-router") != -1) {
                        ...
                        if (type.indexOf("bgp-router") != -1) {
                            ...
                            if(d['physical_routers'] && d['physical_routers'] != '-') {
                                ...
                                details.push({"name":"Assoicated Physical Router", "value": prouterString});
                            }
                        }
...
function createUpdateBgp() {
    //if (validate()) {
        ...
        physicalRouterParams = getPhysicalRoutersJson();
...
//                    updatePhysicalRouter(msg['bgp-router']['name'],'none');
            ...
            var selectedProuter = $("#ddProuter").data('contrailDropdown').value();
            bgpwindow.modal('hide');
            $.ajax({
                type:"PUT",
