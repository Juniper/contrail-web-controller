    ...
    var getConfigureViewConfig = function (isDisable) {
        return {
            elementId: cowu.formatElementId(
                    [prefixId, ctwl.TITLE_EDIT_ALARM]),
                view: "SectionView",
                viewConfig: {
                    rows: [{
                        columns: [{
                                ...
                                elementConfig: {
                                    ...
                                    dataSource: {
                                        ...
                                        data: function () {
                                            ...
                                            return [
                                             {value: '2', text: statusTmpl({sevLevel: 2,
                                                 sevLevels: sevLevels, msg: ctwl.CONFIG_ALARM_MSG_MAP[2]})},
                                             {value: '3', text: statusTmpl({sevLevel: 3,
                                                 sevLevels: sevLevels, msg: ctwl.CONFIG_ALARM_MSG_MAP[3]})},
                                             {value: '4', text: statusTmpl({sevLevel: 4,
                                                 sevLevels: sevLevels, msg: ctwl.CONFIG_ALARM_MSG_MAP[4]})},
                                             {value: '0', text: '0'},
                                             {value: '1', text: '1'},
                                             {value: '5', text: '5'},
                                             {value: '6', text: '6'},
                                    ...
                                    dataSource : {
                                        ...
                                        parse: function(uveList) {
                                            ...
                                            for (var i = 0; i < uveListLen; i++) {
                                                var uveKey = ifNull(uveList[i]['name'], "").slice(0, -1);
