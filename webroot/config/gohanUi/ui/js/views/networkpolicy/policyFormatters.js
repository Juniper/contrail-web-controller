...
define([
    ...
    var PolicyFormatters = function() {
        var self = this;
        this.formatPolicyRule = function(rule) {
            var rule_display = "";
        ...
        this.formatSrcDestAddresses = function(rule) {
            var rule_display = '';
            var addrSrcDest = self.policy_net_display(rule);
       ...
       this.policy_net_display = function(nets) {
            var net_disp_all = "";
                ...
                for (var i = 0; i < nets.length; i++) {
                    ...
                    if (isSet(net)) {
                        ...
                        if (isSet(net["subnet"]) &&
                            ...
                            labelName = ' network ';
                            net_disp += self.prepareFQN(net["virtual_network"]);
        ...
        this.PolicyRulesFormatter = function(r, c, v, cd, dc) {
            ...
            if (policyRule.length > 0) {
                ...
                for (var i = 0; i < count; i++) {
                    var ruleString = self.formatPolicyRule( rule[i] );
