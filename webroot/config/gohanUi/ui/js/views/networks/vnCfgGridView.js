...
define([
    'underscore',
    'contrail-view',
    'config/gohanUi/ui/js/models/vnCfgModel',
    'config/gohanUi/ui/js/views/networks/vnCfgEditView',
                ...
                options: {
                    ...
                    detail: {
                        ...
                        onExpand: function(event, obj){
                                       ctwu.getLocationGrid(event, obj, 'networks', ctwl.CFG_VN_GRID_ID);
                        }
                    }
                },
                dataSource: {},
    ...
    function networkPoliciesFormatter(r, c, v, cd, dc, showAll) {
    	var policies = dc.policies, retString = '-', str = [];
    ...
    var rowActionConfig = [
        ...
        ctwgc.getEditConfig('Edit Local', function(rowIndex) {
            ...
            var ajaxConfig = {
                    url: './gohan_contrail/v1.0/tenant/networks/'+dataItem.id+'/local_networks?sort_key=id&sort_order=asc&limit=25&offset=0',
                    type:'GET'
            };
