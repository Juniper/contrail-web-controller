...
define([
    ...
    var vnCfgModel = ContrailConfigModel.extend({
        ...
        deleteVNCfg : function(selectedGridData, callbackObj){
            ...
            ajaxConfig.url = './gohan_contrail/v1.0/tenant/networks/'+ selectedGridData['id'];
        ...
        addEditVNCfg : function(callbackObj, mode){
            ...
            var newNetworkData = $.extend(true,{},this.model().attributes), newPoliceyRule = [];
                ...
                if(mode === 'POST'){
                    type = "POST";
                    url = "./gohan_contrail/v1.0/tenant/networks";
                }else{
                    type = "PUT";
                    url = "./gohan_contrail/v1.0/tenant/networks/"+newNetworkData.id;
