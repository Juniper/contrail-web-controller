...
define([
    ...
    'contrail-model',
    'knockout',
    'config/gohanUi/ui/js/models/InterfacesModel',
    'config/gohanUi/ui/js/views/instances/svcInst.utils'
    ...
    var SvcInstModel = ContrailModel.extend({
      ...
      gohanServiceInstanceUpdate: function (callbackObj) {
          ...
          var svcInsData = $.extend(true,{},this.model().attributes);
              ...
              var type = "PUT";
              var url = './gohan_contrail/v1.0/tenant/service_instances/'+ svcInsData['id'];
              ajaxConfig = {};
      ...
      deleteGohanSvcInstance : function(selectedGridData, callbackObj){
          ...
          ajaxConfig.data = JSON.stringify(model);
          ajaxConfig.url = './gohan_contrail/v1.0/tenant/service_instances/'+ selectedGridData['id'];
          contrail.ajaxHandler(ajaxConfig, function () {
              if (contrail.checkIfFunction(callbackObj.init)) {
                  callbackObj.init();
              }
      ...
      addSvcInstanceCfg: function (callbackObj) {
          ...
          var newSvcTemplateCfgData = $.extend(true, {}, self.model().attributes);
              ...
              ajaxConfig.url   = './gohan_contrail/v1.0/tenant/service_instances';
