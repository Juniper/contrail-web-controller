...
define([
    ...
    var DnsRecordsGridView = ContrailView.extend({
        ...
        render: function () {
            ...
            this.renderView4Config(self.$el, self.model,
                                   getDnsRecordsGridViewConfig(pagerOptions));
        }
    });
    ...
    var rowActionConfig = [
        ctwgc.getEditConfig('Edit', function(rowIndex) {
            ...
            DnsRecordsEditView.renderEditDnsRecords({
                                  ...
                                  ' (' + dataItem['virtual_DNS_record_data']['record_name'] +
                                     ')',
                                  callback: function () {
                var dataView =
        ...
        ctwgc.getDeleteConfig('Delete', function(rowIndex) {
            ...
            DnsRecordsEditView.renderDeleteDnsRecords({
                                  "title": ctwl.TITLE_DEL_DNS_RECORD + ' ('+ dataItem['virtual_DNS_record_data']['record_name'] 
    ...
    DnsRecordsColumns = [
			...
			formatter: function(row, col, val, d, rowData) {
				var domain = getValueByJsonPath(rowData, 'virtual_DNS_record_data;record_name', "-");
				return domain;
			}
                },
        {
			...
			formatter: function(row, col, val, d, rowData) {
				var domain = getValueByJsonPath(rowData, 'virtual_DNS_record_data;record_type', "-");
				return domain;
			}
                },
                    {
			...
			formatter: function(row, col, val, d, rowData) {
				var fwer = getValueByJsonPath(rowData, 'virtual_DNS_record_data;record_data', "-");
				return fwer;
                	}
		}
    ...
    function showHideModelAttr (model) {
		...
		model.ipAddress = ko.computed((function() {
            ...
            if ((this.user_created_record_type() == 'CNAME') || (this.user_created_record_type() == 'NS') ) {
				return false;
            } 
            return true;
        }), model);
