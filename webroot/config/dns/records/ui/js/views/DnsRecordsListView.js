...
define(
                        ...
                        var listModelConfig = {
                                remote : {
                                    ajaxConfig : {
                                        ...
                                        url : '/api/admin/config/get-data?type=virtual-DNS-record&count=4&fqnUUID=' + dnsUUID,
                                    ...
                                    dataParser : function(response) {
                                        ...
                                        return dnsRecordsDataParser(response)
                                    }
		...
		var vdnsData = getValueByJsonPath(result, "data;virtual-DNS", null);
		var vdnsRecoedsData = getValueByJsonPath(vdnsData, "virtual_DNS_records", []);
