...
/* Register the URL with callback */
  app.get('/api/tenants/config/virtual-DNSs/:id', virtualdnsconfigapi_getVirtualDNSs);
  app.get('/api/tenants/config/list-virtual-DNSs/:id', virtualdnsconfigapi_listVirtualDNSs);
  ...
  parseURLReq.rbac.setFeatureByURL('/api/tenants/config/list-virtual-DNSs/:id', 'get', app.routes, 'virtualdnsconfig');
...
virtualdnsconfigapi_getVirtualDNSs = function(req, res, next) {
  ...
  if (null == reqCtx) {
    ...
    parseURLReq.longPoll.processPendingReq(reqCtx, next, virtualdnsconfigapi.getVirtualDNSs);
  }
}
