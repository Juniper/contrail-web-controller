...
define([
    ...
    var gridElId = '#' + ctwc.GLOBAL_FLOW_OPTIONS_GRID_ID;
        prefixId = ctwc.GLOBAL_FLOW_OPTIONS_PREFIX_ID,
        modalId = 'configure-' + prefixId,
        formId = '#' + modalId + '-form';

    var flowOptionsEditView = ContrailView.extend({
