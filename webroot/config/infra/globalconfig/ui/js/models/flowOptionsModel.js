...
define([
    ...
    var flowOptionsModel = ContrailModel.extend({
        defaultConfig: {
        ...
        configureFlowOptions: function (callbackObj) {
            ...
            if(self.isDeepValid(validations)) {
                ...
                if (null != newFlowOptionsConfig['flow_export_rate']) {
                    flowOptionsData['global-vrouter-config']['flow_export_rate'] =
                        Number(newFlowOptionsConfig['flow_export_rate']);
                }
                ...
                if (contrail.checkIfFunction(callbackObj.error)) {
                    callbackObj.error(this.getFormErrorText(ctwc.GLOBAL_FLOW_OPTIONS_PREFIX_ID));
                }
            }
            return returnFlag;
        }
