    ...
    var bgpCfgModel = ContrailModel.extend({
        ...
        configBGPRouter: function (callbackObj, ajaxMethod) {
            var ajaxConfig = {}, returnFlag = false,
                ...
                postData = { 'content' : {}},
                peers = [], domain = contrail.getCookie(cowc.COOKIE_DOMAIN);
            self  = this;
            var validations = [
                {
                    key : null,
            ...
            if (this.isDeepValid(validations)) {
                ...
                if (newBGPRouterCfgData['fq_name'] == [] ||
                    ...
                    newBGPRouterCfgData['fq_name'][0] = domain;
        ...
        onRouterTypeSelectionChanged: function(newValue) {
            ...
            if(newValue === ctwl.CONTROL_NODE_TYPE) {
                ...
                self.addressFamilyData(ctwc.CN_ADDRESS_FAMILY_DATA);
                self.user_created_address_family(
                ...
                self.user_created_vendor('');
                self.addressFamilyData(ctwc.BGP_ADDRESS_FAMILY_DATA);
                self.user_created_address_family(
                    'inet-vpn,route-target,inet6-vpn,e-vpn');
            }
        }
