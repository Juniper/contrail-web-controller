    ...
    var bgpCfgModel = ContrailModel.extend({
        ...
        formatModelConfig : function(modelConfig) {
            ...
            var selectedPeers = ifNull(modelConfig['bgp_router_refs'],[]),
                ...
                peerCollectionModel;
            var availablePeers = ifNull(window.bgp.availablePeers, []);
                    ...
                    if(selectedPeers.length > 0) {
                        for(var j = 0; j < selectedPeers.length; j++) {
                            ...
                            if(currentPeer.name === selectedPeer.to[4]) {
                                isSelected = true;
                                authData =
                                    selectedPeer.attr.session[0].
                                    attributes[0].auth_data;
                                 break;
                            }
                        }
                    }
        ...
        configBGPRouter: function (callbackObj, ajaxMethod) {
            ...
            if (self.model().isValid(true, "configureValidations")) {
                                ...
                                peers.push(
                                    {
                                        ...
                                        "display_name":self.bgpData[j].display_name,
                ...
                if(newBGPRouterCfgData.user_created_physical_router != 'none') {
                ...
                var asn =
                    newBGPRouterCfgData.bgp_router_parameters.autonomous_system;
                if(asn != null && asn.toString().trim() != '') {
                    newBGPRouterCfgData.bgp_router_parameters.autonomous_system =
                       parseInt(asn.toString().trim());
                }
                //handling auth data
        ...
        validations: {
            configureValidations: {
                ...
                'bgp_router_parameters.autonomous_system' : function(value, attr, finalObj){
                ...
                'user_created_auth_key_type' : function(value, attr, finalObj){
                    if (finalObj['user_created_auth_key'] != 'none'
