...
function initActions() {
    ...
    btnCreateVNOK.click(function (a) {
        ...
        var fqName = vnConfig["virtual-network"]["fq_name"];
...
window.successHandlerForPhysicalRouters =  function(result) {
    ...
    var msPhysicalRouters = $('#msPhysicalRouters').data('contrailMultiselect');
    var currentVal = msPhysicalRouters.value();
    msPhysicalRouters.setData(data);
    msPhysicalRouters.value(currentVal);
}

window.failureHandlerForPhysicalRouters =  function(error) {
    var msPhysicalRouters = $('#msPhysicalRouters').data('contrailDropdown');
    msPhysicalRouters.setData({text:'Error Getting Prouters', value:"Error"});
}
