...
function createRuleEntry(rule, len, vns, policies, subnets, sts) {
    ...
    var selectedDomain = $("#ddDomainSwitcher").data("contrailDropdown").text();
    var selectedProject = $("#ddProjectSwitcher").data("contrailDropdown").text();
    var allVns = [{text:'Enter or Select a Network', value:"dummy", disabled : true },{"text":"ANY (All Networks in Current Porject)","value":"any", "parent": "Networks"},{"text":"LOCAL (All Networks to which this policy is associated)","value":"local", "parent": "Networks"}];
