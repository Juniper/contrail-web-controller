...
define([
    ...
    'config/services/instances/ui/js/models/AllowAddressPairModel'
             ...
             RtAggregateModel, AllowAddressPairModel) {
    ...
    var SvcInstModel = ContrailModel.extend({
        ...
        addAAP: function() {
            ...
            var aapList = this.model().attributes['allowedAddressPairCollection'],
                ...
                AllowAddressPairModel({'interfaceTypesData': types});
        ...
        getAllowedAddressPairsByIntfType: function(aapCollection) {
            ...
            for (var i = 0; i < aapCollectionLen; i++) {
                ...
                aapObj["mac"] = aapCollection[i].mac();
                if ((null != ip) && ("" != ip)) {
                    aapObj["ip"] = {};
                ...
                var addrMode = aapCollection[i].address_mode();
                if ((null != addrMode) && ("" != addrMode)) {
                    aapObj["address_mode"] = addrMode;
                }
