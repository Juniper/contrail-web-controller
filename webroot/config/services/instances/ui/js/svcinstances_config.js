                ...
                if("interface_list" in svcInstance['service_instance_properties'] &&
                   ...
                   svcInstance['service_instance_properties']["interface_list"][tinc]["virtual_network"] != undefined){
                    if(typeof (svcInstance['service_instance_properties']["interface_list"][tinc]["virtual_network"]) == "object" &&
                       svcInstance['service_instance_properties']["interface_list"][tinc]["virtual_network"]).length > 0){
                    ...
                    } else if(typeof (svcInstance['service_instance_properties']["interface_list"][tinc]["virtual_network"]) == "object") {}
                        virNetwork = null;
					} else {
