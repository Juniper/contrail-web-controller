...
define([
    ...
    function getConfiguration (viewConfig) {
        ...
        var gridElementConfig = {
            ...
            columnHeader: { columns: (viewConfig.viewConfig.isInventory === true) ? getfwPolicyInventroyColumns(viewConfig):getfwPolicyColumns(viewConfig)},
            footer: {
                pager: {
                    options: {
                        pageSize: 50,
    ...
    function getfwPolicyInventroyColumns(viewConfig){
        var fwPolicyColumns = [{
            id: 'name',
            field: 'name',
            minWidth : 100,
