        ...
        render: function () {
            ...
            self.renderView4Config(self.$el, self.model, 
                    ...
                    function(){
                        ...
                        var info = $('<span class="fa fa-info-circle" title="Port format ( Protocol:SrcPort:DstPort or Protocol:DstPort )"></span>');
          ...
          },
          {
            ...
            formatter: fwRuleFormatter.actionFormatter
             ...
             formatter: function(r,c,v,cd,dc){
                 return fwRuleFormatter.serviceFormatter("", "", v, "", dc, isGlobal, true);
             }
         },{
             id: 'endpoint_1',
             field: 'endpoint_1',
