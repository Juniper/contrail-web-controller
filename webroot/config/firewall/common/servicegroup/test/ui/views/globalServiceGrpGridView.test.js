...
define([
    ...
    'ct-test-utils',
    'ct-test-messages',
    'config/firewall/common/servicegroup/test/ui/views/globalServiceGrpGridView.mock.data',
    'co-grid-contrail-list-model-test-suite',
    'co-grid-view-test-suite'
], function (cotc, cotr, cttu, cttm, TestMockdata, GridListModelTestSuite, GridViewTestSuite) {

    var moduleId = cttm.GLOBAL_SERVICE_GRP_GRID_VIEW_COMMON_TEST_MODULE;
    ...
    cotr.startTestRunner(pageTestConfig, true);
