...
var applicationPolicyProjectPageLoader = new ApplicationPolicyProjectPageLoader();

function ApplicationPolicyProjectPageLoader ()
{
    this.load = function (paramObject) {
        var self = this, currMenuObj = globalObj.currMenuObj,
            hashParams = paramObject['hashParams'],
            rootDir = currMenuObj['resources']['resource'][1]['rootDir'],
            pathSecurityPolicyView = rootDir + '/js/views/applicationPolicyProjectView.js',
