    ...
    var PhysicalRouterModel = ContrailModel.extend({
        ...
        populateTORAgentVirtualRouterObjectToPostObj : function(postObject,
            ...
            $.each(editData,function(j,vrouter){
               if(vrouter['to'][1].trim() == selectedVRouters.user_created_torAgent1){
            ...
            $.each(editData,function(j,vrouter){
                if(vrouter['to'][1].trim() == selectedVRouters.user_created_torAgent2){
                    isTorAlreadyFromEdit = true;
                }
            });
            ...
            $.each(editData,function(j,vrouter){
                if(vrouter['to'][1].trim() == selectedVRouters.user_created_tsn1){
            ...
            $.each(editData,function(j,vrouter){
                if(vrouter['to'][1].trim() == selectedVRouters.user_created_tsn2){
                    isTsnAlreadyFromEdit = true;
                }
            });
