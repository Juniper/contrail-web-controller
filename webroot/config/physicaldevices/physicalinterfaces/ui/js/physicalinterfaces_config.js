...
//        ddLIType.setData([{text : 'L2 Gateway', value : 'l2Gateway'}, {text : 'L2 Server', value : 'l2Server'}, {text : 'L3', value : 'l3'}]);
    ...
    function createUpdatePhysicalInterface() {
        ...
        doAjaxCall(url, methodType, JSON.stringify(postObject), 'successHandlerForCreatePhysicalInterfaces', 'failureHandlerForCreatePhysicalInterfaces', null, {isPIFlow : doubleCreation});
    }
...
//                $('#txtVMI').attr('disabled', 'disabled');
    ...
    function fetchPhysicalInterfaces() {
        ...
        'successHandlerForPhysicalInterfacesNew', 'failureHandlerForPhysicalInterfaces', null, null, ajaxTimeout);
    }
