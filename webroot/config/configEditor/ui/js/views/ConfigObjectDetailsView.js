        ...
        render: function() {
            ...
            $(contentContainer).find('.config-jSon-form-edit').on('click',function(){
            	self.renderView4Config(null, null,{
                    ...
                    viewConfig: {
                    	schema: self.schema, //JSON.parse(cowu.deSanitizeConfigObj(JSON.stringify(self.schema))),//self.schema,
                    	json : objModel,//JSON.parse(cowu.deSanitizeConfigObj(JSON.stringify(objModel))),//objModel,
                    	onSaveCB : function(){
