...
define([
    ...
    var CTLabels = function () {
        ...
        var labelMap = {
            ...
            virtual_network_refs: "External Gateway",
            virtual_machine_interface_refs: "Connected Network",
            Id_perms: "Router Interfaces"
        };
        ...
        this.SELECT_EXT_GWAY = "Select External Gateway";
