...
###4.1 Navigation Link
* Add a new Load Balancing link in sidebar to Monitor.
<br>
![image](images/LBaaS_Monitor_LB.png)

* Add a new Load Balancing Link in sider to Configure.
<br>
...
Navigate to **Configure** workspace and under **Networking** section, you see **Load Balancing**
* Click on “+”
...
**Step1 - Load Balancer Details:** The subnet is the network on which to allocate the load balancer's IP address. If an IP address is provided it must be a well-formed IPv4 or IPv6 address. The system will attempt to assign the provided IP address to the load balancer.
  ...
  * IP address: optional
  * Provider : opencontrail (Service Appliance Sets) default opencontrail
